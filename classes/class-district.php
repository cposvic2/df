...
class DeedfaxDistrict {
	...
	public function getEditLink() {
		...
		return menu_page_url( 'deedfax-streets', false ).'&'.http_build_query($query);
	}
}

class DeedfaxDistrictDAO extends DeedfaxBaseDAO {
	protected $_tableName = DEEDFAX_DISTRICT_TABLE;
